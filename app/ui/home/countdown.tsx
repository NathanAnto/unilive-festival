...
export default function Countdown() {
    ...
    return (
        <>
            <h1
                className={`flex flex-row justify-center mb-4 text-4xl sm:m-0 md:m-0 font-extrabold leading-none tracking-tight text-primary md:text-3xl lg:text-3xl dark:text-primary animate-pulse`}
            >
                {isClient ? "Unilive 2025 dans:" : <div className="skeleton h-4 w-full"></div>}
            </h1>
            <div className='flex flex-row justify-center gap-2 p-2 md:gap-5 md:p-5 text-xs'>
                {timeLeft.months > 0 ? <div className="flex flex-col items-center bg-base-100 rounded-lg p-2 md:p-4 shadow-lg hover:scale-105 transition-transform">
                ...
                <div className="flex flex-col items-center bg-base-100 rounded-lg p-2 md:p-4 shadow-lg hover:scale-105 transition-transform">
                    <span className='countdown font-mono text-4xl text-primary'>
                ...
                <div className="flex flex-col items-center bg-base-100 rounded-lg p-2 md:p-4shadow-lg hover:scale-105 transition-transform">
                    <span className='countdown font-mono text-4xl text-primary'>
